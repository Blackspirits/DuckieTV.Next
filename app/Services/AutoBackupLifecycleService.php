...
class AutoBackupLifecycleService
{
    ...
    public function status(?int $nowMilliseconds = null, ?string $timezoneName = null): array
    {
        ...
        $now = $this->dateFromMilliseconds($currentMilliseconds, $timezone);
        ...
        $lastRun = $this->dateFromMilliseconds($lastRunMilliseconds, $timezone);
